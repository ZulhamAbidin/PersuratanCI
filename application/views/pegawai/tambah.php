                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" value="zlhm" name="nama" id="nama" type="text" value="<?= set_value('nama'); ?>" />
                        </div>
                        <?= form_error('nama', '<div class="text-danger">', '</div>'); ?>

                        <div class="form-group">
                            <label class="label-control">NIP</label>
                            <input class="form-control" value="NIP" name="nip" id="nip" type="text" value="<?= set_value('nip'); ?>" />
                        </div>
                        <?= form_error('nip', '<div class="text-danger">', '</div>'); ?>

                        <div class="form-group">
                            <label class="label-control">Tempat Lahir</label>
                            <input class="form-control"  value="makassar" name="tempat_lahir" id="tempat_lahir" type="text" value="<?= set_value('tempat_lahir'); ?>" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" value="alamat" name="alamat" id="alamat" type="text" value="<?= set_value('alamat'); ?>" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" value="0895801138822" name="no_hp" id="no_hp" type="text" value="<?= set_value('no_hp'); ?>" />
                        </div>
                        <?= form_error('no_hp', '<div class="text-danger">', '</div>'); ?>

                        <div class="form-group">
                            <label class="label-control">Jabatan</label>
                            <input class="form-control" value="Staff" name="jabatan" id="jabatan" type="text" value="<?= set_value('jabatan'); ?>" />
                        </div>
                        <?= form_error('jabatan', '<div class="text-danger">', '</div>'); ?>

                        <div class="form-group">
                            <label class="label-control">Pendidikan</label>
                            <input class="form-control" value="sma" name="pendidikan" id="pendidikan" type="text" value="<?= set_value('pendidikan'); ?>" />
                        </div>

    ...
    public function tambah()
{
    ...
    if ($this->form_validation->run() == FALSE) {
        ...
        if ($this->upload->do_upload('foto')) {
            ...
            // Handle error here or redirect back with error message
        }
    }
}

// Callback function for checking file upload
public function file_check($str)
{
    ...
    if (in_array($mime, $allowed_mime_types)) {
        ...
        $this->form_validation->set_message('file_check', 'File yang diunggah harus berupa gambar (JPG, JPEG, PNG).');
        return FALSE;
    }
}
